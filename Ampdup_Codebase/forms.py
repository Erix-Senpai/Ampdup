...
from wtforms.fields import TextAreaField, SubmitField, StringField, PasswordField, FileField, EmailField
...
class LoginForm(FlaskForm):
    ...
    password_hash =PasswordField("Password", validators=[InputRequired('Please enter your password')])
...
class RegisterForm(FlaskForm):
    ...
    email = EmailField("Email Address", validators=[DataRequired(), Email("Please enter a valid email")])
